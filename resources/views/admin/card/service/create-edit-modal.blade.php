<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-hidden="true"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="{{route('admin.cardService.store').'?card_id='.$card->id}}" method="POST"
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-12">
                            ...
                            <strong>@lang('Image size should be '){{config('filelocation.cardService.size')}} @lang('for better resolution')</strong>
                            @error("image")
                            <span class="invalid-feedback d-block">{{ $message }}</span>
                            @enderror
                        </div>
