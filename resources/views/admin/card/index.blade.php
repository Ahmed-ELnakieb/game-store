    ...
    <div class="content container-fluid">
        ...
        <div class="row d-none" id="statsSection">
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$cards['activeCard']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$cards['totalCard']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-success text-success p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($cards['activeCardPercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("InActive Card")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$cards['inActiveCard']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$cards['totalCard']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-danger text-danger p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($cards['inActiveCardPercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Today Created Card")</h6>

                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$cards['todayCard']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$cards['totalCard']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-info text-info p-1">
                                <i class="bi-graph-down"></i> {{$cards['todayCardPercentage']??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("This Month Created Card")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$cards['thisMonthCard']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">from {{$cards['totalCard']??0}}</span>
                            </div>
                            <div class="col-auto">
                                <span class="badge bg-soft-success text-success p-1">{{fractionNumber($cards['thisMonthCardPercentage'])??0}}%</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header card-header-content-md-between">
                        <div class="mb-2 mb-md-0">
                            <div class="input-group input-group-merge navbar-input-group">
                                ...
                                <input type="search" id="datatableSearch"
                                       ...
                                       placeholder="@lang('Search Card')"
                                       aria-label="@lang('Search Card')"
                                       autocomplete="off">
                        ...
                        <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                            <div id="datatableCounterInfo">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a class="btn btn-outline-primary btn-sm me-2" href="javascript:void(0)"
                                       ...
                                       data-bs-target="#multipleTrendingChange">
                                        <i class="fal fa-chart-line-up pe-2"></i> @lang('Trending Stage Change')
                                    </a>
                                    <a class="btn btn-outline-primary btn-sm me-2" href="javascript:void(0)"
                                       data-bs-toggle="modal"
                            ...
                            <a class="btn btn-primary btn-sm" href="{{route('admin.card.store')}}">
                                <i class="fas fa-vr-cardboard me-1"></i> @lang('Create Card')
                            </a>
                            <div class="dropdown">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="filter_form">
                                                <div class="mb-4">
                                                            <span
                                                                class="text-cap text-body">@lang('Card Name')</span>
                                                    <div class="row">
                                                        <div class="col-12">
                    ...
                    <div class=" table-responsive datatable-custom">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                <th scope="col">@lang('Instant Delivery')</th>
                                <th scope="col">@lang('Trending')</th>
...
@push('script')
    <script>
        ...
        $(document).on('click', '.delete_btn', function () {
            ...
            $('#deleteModalBody').text('Are you sure you want to proceed with the deletion of this card?');
            $('.deleteModalRoute').attr('action', route);
        });

        $(document).on('click', '.trending_btn', function () {
            let route = $(this).data('route');
            $('.trendingModalRoute').attr('action', route);
        });
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route("admin.card.search").'?category_id='.$category_id }}",
                },
                ...
                columns: [
                    ...
                    {data: 'instant_delivery', name: 'instant_delivery'},
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.card.search").'?category_id='.$category_id }}" + "&name=" + name +
            ...
            $(document).on('click', '.delete-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.card.multipleDelete') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
            ...
            $(document).on('click', '.trending-multiple', function (e) {
                e.preventDefault();
                let all_value = [];
                $(".row-tic:checked").each(function () {
                    all_value.push($(this).attr('data-id'));
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.card.multipleTrending') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
            ...
            $(document).on('click', '.change-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.card.multipleStatusChange') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
