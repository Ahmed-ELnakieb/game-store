...
class BasicControlSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('basic_controls')->truncate();
...
<div class="wrapper" style="min-width: 320px;background-color: #f5f7fa;" lang="x-wrapper">
    ...
    'measurement_id' => 'XXXXXXXXXXXXXXX',
    'analytic_status' => 1,
    'error_log' => 0,
    'is_active_cron_notification' => 1,
    'logo' => 'logo/2goyRo7MeBAt8eCZW0ZcHfP80SLiNZ.webp',
    'logo_driver' => 'local',
    'favicon' => 'logo/bB6DWZcUQbASh6YVkrUycuIFOkmON4.webp',
    'favicon_driver' => 'local',
    'admin_logo' => 'logo/iriu4ngGjiHcqlj4eFCsLzUNSy0FY1.webp',
    'admin_logo_driver' => 'local',
    'admin_dark_mode_logo' => 'logo/f1OTohWTyPMu9zhPkSXnVv4r24GjtO.webp',
    'admin_dark_mode_logo_driver' => 'local',
    'currency_layer_access_key' => 'XXXXXXXXXXXX',
    'currency_layer_auto_update_at' => 'everyMinute',
    'currency_layer_auto_update' => 0,
    'coin_market_cap_app_key' => 'XXXXXXXXXXXX',
    ...
    'cookie_button' => 'See more',
    'cookie_button_link' => 'cookie-policy',
    'cookie_image' => 'cookie/mMlmi1wOgdEIIlB8S9Oxpp7kA8IcKT.webp',
    'cookie_image_driver' => 'local',
    'table_view' => 'flex',
    'sell_post' => 1,
    'payment_expired' => 30,
    'payment_released' => 7,
    ...
    'card' => 1,
    'created_at' => NULL,
    'updated_at' => '2025-03-09 07:38:07',
    'app_color' => '#2c9cfe',
    'app_version' => '1.1.0',
    'app_build' => '25,26,27',
    'is_major' => '1',
    'light_primary_color' => '#6f4ff2',
    'light_secondary_color' => '#292d32',
    'dark_primary_color' => '#6f4ff2',
    'dark_secondary_color' => '#000000',
  ),
)
        );
    }
