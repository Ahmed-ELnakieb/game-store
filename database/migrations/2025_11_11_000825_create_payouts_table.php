...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('payouts', function (Blueprint $table) {
            ...
            $table->unsignedInteger('payout_method_id')->nullable();
            ...
            $table->decimal('amount_in_base_currency', 18, 8)->default(0);
            $table->decimal('charge_in_base_currency', 18, 8)->default(0);
            $table->decimal('net_amount_in_base_currency', 18, 8)->default(0);
